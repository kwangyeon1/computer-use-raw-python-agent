...
```bash
./.venv/bin/python -m pip install -e '.[sglang]'
```
...
현재 기본 SGLang 설정은 `bitsandbytes` 8bit 경로를 사용하도록 잡혀 있습니다.
- `sglang_load_format = "bitsandbytes"`
- `sglang_quantization = "bitsandbytes"`
